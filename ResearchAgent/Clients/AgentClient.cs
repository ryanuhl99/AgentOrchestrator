        ...
        try
        {
            ...
            if (!response.IsSuccessStatusCode)
            {
                ...
                throw new HttpRequestException(
                    $"ResearchAgent error at CompleteAsync Status: {response.StatusCode} Error: {error?.Error?.Message}"
                );
            }
            ...
            {
                throw new Exception("ResearchAgent CompleteAsync returned empty response");
            }
