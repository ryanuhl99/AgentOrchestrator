        ...
        try
        {
            ...
            if (!response.IsSuccessStatusCode)
            {
                ...
                throw new HttpRequestException(
                    $"CodeAgent error at CompleteAsync Status: {response.StatusCode} Error: {error?.Error?.Message}"
                );
            }
            ...
            {
                throw new Exception("CodeAgent CompleteAsync returned empty response");
            }
